      ...
      $main.insertAdjacentHTML('beforeend', `
        <div class="declaracao">
          ...
          <div class="row linha">
            <div class="col-md-2">
              <div class="bloco">
                <img src="https://helladrinkinghorns.com/wp-content/uploads/2021/01/logotipo_semfundo.png" style="height : 170px; width: 180px; "></img>
              </div>
            </div>
            <div class="col-md-4">
              <div class="bloco" style="text-align: left; padding: 8px">
                Destinatário
                <div class="texto" style="font-size: 17px">
                  <b>Nome:</b> ${getCelText('desNome')}<br>
                  <b>Endereço:</b> ${getCelText('desEndereco')}, ${getCelText('desLinha2')}<br>
                  <b>Cidade:</b> ${getCelText('desCidade')}<br>
                  <b>UF:</b> ${getCelText('desUf')}<br>
                  <b>CEP:</b> ${getCelText('desCep')}<br>
                </div>
              </div>
            </div>
          ...
          <div class="col-md-4">
            <div class="bloco" style="text-align: left; padding: 8px">
              Remetente
              <div class="texto" style="font-size: 17px">
              <b>Nome:</b> ${getCelText('remNome')}<br>
              <b>Endereço:</b> ${getCelText('remEndereco')}, ${getCelText('desLinha2')}<br>
              <b>Cidade:</b> ${getCelText('remCidade')}<br>
              <b>UF:</b> ${getCelText('remUf')}<br>
              <b>CEP:</b> ${getCelText('remCep')}<br>
              </div>
            </div>
          </div>
        </div>
